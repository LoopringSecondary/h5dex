              ...
              fills.items && fills.items.map((item,index)=>{
                ...
                return (
                  <tr key={index}>
                    ...
                    <td className="pl5 pr5 pt10 pb10 zb-b-b color-black-2 text-right align-middle">
                      {fillFm.getAmount()}
                    </td>
                    <td className="pl5 pr5 pt10 pb10 zb-b-b text-right color-black-2 align-middle">
                      {fillFm.getLRCFee()}
