  ...
  return (
    <div className="fs20">
      <div className="zb-b-b p10">
        <div className="fs14 color-black-1 mb5">技巧提示</div>
        ...
        <div className="fs12 color-black-2 lh20">
          1. 手续费比例多少？0.1% <br />
          2. 什么时候扣除手续费？成交时由智能合约自动转给矿工 <br />
        </div>
      </div>
            <div className="zb-b-b p10">
        <div className="fs14 color-black-1 mb5">操作说明</div>
        <div className="fs12 color-black-2 lh20">
      ...
      <div className="zb-b-b p10">
        <div className="fs14 color-black-1 mb5">交易体验特点</div>
        <div className="fs12 color-black-2 lh20">
