    ...
    <div>
        ...
        <InputItem
          ...
          extra={
            <div style={{width:'25px',textAlign:'right'}}>
              <i className="icon-chevron-right fs18 color-black-2" style={{padding:'2px 0px 5px'}}onClick={showLayer.bind(this,{id:'helperOfPrice',side:'sell'})} />
            </div>
          }
      ...
      <List className="bg-none no-border">
        <InputItem
          ...
          extra={
            <div style={{width:'25px',textAlign:'right'}}>
              <i className="icon-chevron-right fs18 color-black-2" style={{padding:'2px 0px 5px'}} onClick={showAmountHelper} />
            </div>
          }
