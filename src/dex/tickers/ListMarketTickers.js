      ...
      <div className="row ml0 mr0 p10 align-items-center zb-b-b no-gutters" onClick={gotoDetail}>
        ...
        <div className="col-3 text-right">
          ...
          }
          {
            ...
            <Button style={{height:'36px',lineHeight:'36px'}} className="border-none pl10 pr10 fs16 bg-grey-100 color-white">
             {tickerFm.getChange()}
            </Button>
          }
          {
  ...
  render(){
      ...
      return (
          ...
          >
            <div>
              <TickerHeader />
              {allTickers.map((item,index)=><TickerItem key={index} item={item} actions={actions} />)}
            </div>
