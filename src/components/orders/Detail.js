...
const OrderMetaItem = (props) => {
  ...
  return (
    <div className="row ml0 mr0 pt10 pb10 zb-b-b no-gutters" style={{padding:'7px 0px'}}>
      <div className="col">
        ...
        <Pages active="order">
          <Page id="order" render={({page})=>
            <div className="bg-white">
              ...
              <Tabs
                tabs={[
                  { title: <div className="text-center">Issues</div> },
                  { title: <div className="text-center">Detail</div> },
                  { title: <div className="text-center">Fills <Badge count={3} className="bg-white color-grey-900" /></div> },
              ...
              >
                ...
                <div className="bg-white">
                  <div className="p15">
                    <OrderMetaItem label="状态" value="进行中" />
                    <OrderMetaItem label="成交量" value="( 80% ) 8000 LRC" />
