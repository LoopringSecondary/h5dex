  ...
  return (
    <div style={{maxHeight,overflow:'auto'}}>
      <table className="w-100">
        <thead>
          <tr className="">
            <th className="zb-b-b text-left pl10 pr10 pt5 pb5 font-weight-normal color-black-3 fs14">Amount</th>
            <th className="zb-b-b text-right pl10 pr10 pt5 pb5 font-weight-normal color-black-3 fs14">Buy</th>
            <th className="zb-b-b text-left pl10 pr10 pt5 pb5 font-weight-normal color-black-3 fs14">Sell</th>
            <th className="zb-b-b text-right pl10 pr10 pt5 pb5 font-weight-normal color-black-3 fs14">Amount</th>
          </tr>
        </thead>
        <tbody>
            {
              depth.items.map((item,index)=>
                <tr key={index}>
                  <td className="fs14 pl10 pr10 pt10 pb10 zb-b-b color-black-2 text-left align-middle">
                    1000.0000
                  </td>
                  <td className="fs14 pl10 pr5 pt10 pb10 zb-b-b text-right color-green-500 align-middle">
                    0.00015000
                    <div hidden className="fs12 color-black-4 mr5">￥8.52</div>
                  </td>
                  <td className="fs14 pl10 pr5 pt10 pb10 zb-b-b text-left color-red-500 align-middle">
                    0.00015000
                    <div hidden className="fs12 color-black-4 mr5">￥8.52</div>
                  </td>
                  <td className="fs14 pl10 pr10 pt10 pb10 zb-b-b color-black-2 text-right align-middle">
                    1000.0000
                  </td>
                </tr>
              )
  ...
  return (
    <div style={{maxHeight,overflow:'auto'}}>
      <table className="w-100">
        <thead>
          <tr className="">
            <th className="zb-b-b bg-grey-100 text-left pl10 pr10 pt5 pb5 font-weight-normal color-black-3 fs14">Price</th>
            <th className="zb-b-b bg-grey-100 text-right pl10 pr10 pt5 pb5 font-weight-normal color-black-3 fs14">Amount</th>
            <th className="zb-b-b bg-grey-100 text-right pl10 pr10 pt5 pb5 font-weight-normal color-black-3 fs14">Fee</th>
            <th className="zb-b-b bg-grey-100 text-right pl10 pr10 pt5 pb5 font-weight-normal color-black-3 fs14">Time</th>
          </tr>
        </thead>
        <tbody>
            {
              fill.items.map((item,index)=>
                <tr key={index}>
                  {
                    index%2===0 &&
                    <td className="fs14 pl10 pr5 pt10 pb10 zb-b-b text-left align-middle color-green-500">
                      0.00015000
                    </td>
                  }
                  {
                    index%2===1 &&
                    <td className="fs14 pl10 pr5 pt10 pb10 zb-b-b text-left align-middle color-red-500">
                      0.00015000
                    </td>
                  }
                  <td className="fs14 pl10 pr10 pt10 pb10 zb-b-b color-black-2 text-right align-middle">
                  ...
                  <td className="fs14 pl10 pr5 pt10 pb10 zb-b-b text-right color-black-2 align-middle">
                    2.55 LRC
                    <div hidden className="fs12 color-black-4 mr5">￥8.52</div>
                  </td>
                  <td className="fs14 pl10 pr10 pt10 pb10 zb-b-b color-black-2 text-right align-middle">
